...
use asbamboo\openpayWxpay\wxpayApi\requestParams\unit\PayRefundParams;
 ...
 * @since 2018年11月20日
 */
class PayRefund implements RequestInterface
{
    use GatewayUriTrait;
    use BodyTrait;
    ...
    {
        $Uri    = $this->getGateway();
        $path   = rtrim($Uri->getPath(), '/') . '/secapi/pay/refund';
    ...
    {
        $this->RequestParams  = new PayRefundParams();
