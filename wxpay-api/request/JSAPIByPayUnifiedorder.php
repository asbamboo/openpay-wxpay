...
use asbamboo\openpayWxpay\wxpayApi\requestParams\unit\JSAPIByPayUnifiedorderParams;
 ...
 * @since 2018年10月12日
 */
class JSAPIByPayUnifiedorder implements RequestInterface
{
    use GatewayUriTrait;
    use BodyTrait;
    ...
    {
        $this->RequestParams  = new JSAPIByPayUnifiedorderParams();
