...
use asbamboo\openpayWxpay\wxpayApi\requestParams\unit\CloseOrderParams;
 ...
 * @since 2018年11月20日
 */
class CloseOrder implements RequestInterface
{
    use GatewayUriTrait;
    use BodyTrait;
    ...
    {
        $Uri    = $this->getGateway();
        $path   = rtrim($Uri->getPath(), '/') . '/pay/closeorder';
    ...
    {
        $this->RequestParams  = new CloseOrderParams();
